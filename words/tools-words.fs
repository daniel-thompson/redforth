...
: MANGLE	( c-addr1 u1 -- c-addr2 u2 )
	...
	2DUP S" O_RDONLY" COMPARE 0= IF 2DROP S" C_O_RDONLY" THEN
	2DUP S" O_WRONLY" COMPARE 0= IF 2DROP S" C_O_WRONLY" THEN
	2DUP S" O_CREAT" COMPARE 0= IF 2DROP S" C_O_CREAT" THEN
	2DUP S" O_TRUNC" COMPARE 0= IF 2DROP S" C_O_TRUNC" THEN
	2DUP S" O_APPEND" COMPARE 0= IF 2DROP S" C_O_APPEND" THEN
